...
class ScheduledTask:
    def __init__(self, gpo_type="computer", name="", mod_date="", description="", powershell=False, command="", old_value="", filteruser=0, filtercomputer=0, sammacount="None", user_sid="None"):
        self._type = gpo_type
